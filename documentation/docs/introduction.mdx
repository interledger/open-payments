...
[account servicers](./terminology#account-servicer) (we just say **wallets** but
it could be banks, PSPs, or anyone sending or receiving payments for their
users) to setup and authorize payments for a variety of common
[use cases](./p2p).
...
the assumption is that accounts [discovered](./discovery) via Open payments
support Interledger for making the payment itself.
