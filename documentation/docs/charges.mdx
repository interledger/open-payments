...
A Client creates a Charge by doing an HTTP POST of a JSON document
on the Mandate URI for which they wish to perform the Charge against, appending `/charges` to the Mandate URI path.
...
The following is a non-normative example of a Client creating a Charge against a Mandate identified by `//issuer.wallet/mandates/2fad69d0-7997-4543-8346-69b418c479a6`.
