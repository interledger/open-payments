...
| assetCode   | string   | The asset code of the amount                                                  |
| assetScale  | int32    | The scale of the amount                                                       |
...
connections sub-resource URL as defined in the [connections API](./connections).
