...
- Asegura la redirección al agregar un [hash único](/identity/hash-verification), lo que le permite a su cliente validar la llamada de `finish`, y una referencia de interacción como parámetros de consulta al URI.
