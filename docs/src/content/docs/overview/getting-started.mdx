...
<CardGrid>
  <LinkCard
    ...
    description="For client developers writing apps and services that call the Open Payments APIs."
  />
  <LinkCard
    title="Implementing Open Payments"
    href="/overview/for-ases/"
    description="For ASE engineers building the wallet address, resource, and authorization servers that make accounts Open Payments-enabled."
  />
</CardGrid>
