...
- <LinkOut href='https://github.com/interledger/open-payments-node/tree/main/packages/open-payments#example'>E-commerce example using the Open Payments SDK</LinkOut>
