...
The [Get an Incoming Payment API](/apis/#resource-server/tag/incoming-payment/GET/incoming-payments/%7Bid%7D) lets you get the latest state of an incoming payment resource.
...
- [Resource server API reference](/apis/#resource-server/tag/incoming-payment/GET/incoming-payments/%7Bid%7D)
