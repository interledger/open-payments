...
The [Create Incoming Payment API](/apis/resource-server/operations/create-incoming-payment) lets you request the creation of an incoming payment resource. An incoming payment resource must be created before any payments can be sent to a wallet address.
