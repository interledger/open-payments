...
The [Create Incoming Payment API](/apis/resource-server/#tag/incoming-payment/POST/incoming-payments) lets you request the creation of an incoming payment resource. An incoming payment resource must be created before any payments can be sent to a wallet address.
...
- [Resource server API reference](/apis/resource-server/#tag/incoming-payment/POST/incoming-payments)
