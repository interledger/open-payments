...
The [Get Keys Bound to Wallet Address API](/apis/#tag/wallet-address/GET/jwks.json) lets you get the public keys associated with a wallet address.
...
- [Wallet address server API reference](/apis/#tag/wallet-address/GET/jwks.json)
