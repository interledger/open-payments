...
The [Get Keys Bound to Wallet Address API](/apis/wallet-address-server/#tag/wallet-address/GET/jwks.json) lets you get the public keys associated with a wallet address.
...
- [Wallet address server API reference](/apis/wallet-address-server/#tag/wallet-address/GET/jwks.json)
