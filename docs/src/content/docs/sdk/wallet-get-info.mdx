...
<ChunkedSnippet
  source="wallet-address/wallet-address-get.ts"
  l="node"
  chunk="3"
/>
...
<ChunkedSnippet
  source="wallet-address/wallet-address-get.rs"
  l="rust"
  chunk="1"
/>
...
<LinkButton href="https://github.com/interledger/open-payments-java?tab=readme-ov-file#prerequisites" target="_blank" icon="external" iconPlacement="start">Prerequisites</LinkButton>
    ...
    var walletAddress = client.getWalletAddress("https://cloudninebank.example.com/customer");
