...
The [Get Wallet Address API](/apis/#wallet-address-server/tag/wallet-address/GET/) lets you get the public information for a wallet address.
...
- [Wallet address server API reference](/apis/#wallet-address-server/tag/wallet-address/GET/)
