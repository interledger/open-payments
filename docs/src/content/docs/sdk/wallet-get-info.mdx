...
{/* prettier-ignore */}
<p><LinkOut href='https://github.com/interledger/open-payments/blob/main/snippets/rust/wallet-address/wallet-address-get.rs'>View full Rust source</LinkOut></p>
