...
{/* prettier-ignore */}
<p><LinkOut href='https://github.com/interledger/open-payments/blob/main/snippets/rust/token/token-rotate.rs'>View full Rust source</LinkOut></p>
