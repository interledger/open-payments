...
The [Get an Outgoing Payment API](/apis/#resource-server/tag/outgoing-payment/GET/outgoing-payments/%7Bid%7D) lets you get the latest state of an outgoing payment resource.
...
- [Resource server API reference](/apis/#resource-server/tag/outgoing-payment/GET/outgoing-payments/%7Bid%7D)
