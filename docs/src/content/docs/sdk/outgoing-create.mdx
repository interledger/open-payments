...
The [Create an Outgoing Payment API](/apis/resource-server/operations/create-outgoing-payment) lets you request the creation of an outgoing payment resource.
