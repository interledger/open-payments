...
The [Create an Outgoing Payment API](/apis/resource-server/#tag/outgoing-payment/POST/outgoing-payments) lets you request the creation of an outgoing payment resource.
...
- [Resource server API reference](/apis/resource-server/#tag/outgoing-payment/POST/outgoing-payments)
