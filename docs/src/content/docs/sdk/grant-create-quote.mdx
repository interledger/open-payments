...
The [Grant Request API](/apis/#auth-server/tag/grant/POST/) lets you request a grant for quote, outgoing payment, and incoming payment resources.
...
- [Auth server API reference](/apis/#auth-server/tag/grant/POST/)
