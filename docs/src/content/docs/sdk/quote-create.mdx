...
The [Create Quote API](/apis/resource-server/#tag/quote/POST/quotes) lets you request the creation of a quote resource against the sender's wallet address.
...
- [Resource server API reference](/apis/resource-server/#tag/quote/POST/quotes)
