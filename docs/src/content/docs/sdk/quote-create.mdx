...
The [Create Quote API](/apis/#tag/quote/POST/quotes) lets you request the creation of a quote resource against the sender's wallet address.
...
<br />
Create this type of quote when the incoming payment resource already has a
...
<LinkOut href="https://github.com/interledger/open-payments-dotnet/blob/main/OpenPayments.Snippets/Services/Authenticated/QuoteService.cs#L37-L59">
  View full source
</LinkOut>
</TabItem>
</Tabs>
...
<Badge text="Authenticated client required" variant="note" />
<br />
Create this type of quote to specify a debit amount. The debit amount is the
amount to deduct from the sender's wallet.
...
<Badge text="Authenticated client required" variant="note" />
<br />
Create this type of quote to specify a receive amount. The receive amount is the
amount that will be paid into the recipient's wallet.
...
- [Resource server API reference](/apis/#tag/quote/POST/quotes)
- [Quote resource](/concepts/resources/#quote)
