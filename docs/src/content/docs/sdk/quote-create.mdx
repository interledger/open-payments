...
The [Create Quote API](/apis/resource-server/operations/create-quote) lets you request the creation of a quote resource against the sender's wallet address.
