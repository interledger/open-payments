...
The [Grant Continuation Request API](/apis/#tag/grant/POST/continue/%7Bid%7D) lets you continue an interactive grant request during or after user interaction.
...
- [Auth server API reference](/apis/#tag/grant/POST/continue/%7Bid%7D)
