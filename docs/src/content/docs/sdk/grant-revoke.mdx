...
<ChunkedSnippet
  source='grant/grant-revoke.rs'
  l='rust'
  chunk='3'
/>

{/* prettier-ignore */}
<p><LinkOut href='https://github.com/interledger/open-payments/blob/main/snippets/rust/grant/grant-revoke.rs'>View full Rust source</LinkOut></p>
