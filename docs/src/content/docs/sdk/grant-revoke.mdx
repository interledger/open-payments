...
If your client no longer needs access to protected resources, the [Cancel Grant API](/apis/auth-server/#tag/grant/DELETE/continue/%7Bid%7D) lets you cancel (revoke) the corresponding grant request.
...
- [Auth server API reference](/apis/auth-server/#tag/grant/DELETE/continue/%7Bid%7D)
