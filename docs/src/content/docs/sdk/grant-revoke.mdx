...
If your client no longer needs access to protected resources, the [Cancel Grant API](/apis/auth-server/operations/delete-continue) lets you cancel (revoke) the corresponding grant request.
