...
The [Complete an Incoming Payment API](/apis/resource-server/#tag/incoming-payment/POST/incoming-payments/%7Bid%7D/complete) lets you complete an unexpired incoming payment.
...
- [Resource server API reference](/apis/resource-server/#tag/incoming-payment/POST/incoming-payments/%7Bid%7D/complete)
