...
- <LinkOut href='https://github.com/interledger/open-payments-node'>
    TypeScript/NodeJS
  </LinkOut>
...
6. Enter an amount between 50 to 1,000 to deposit into the account, then click **Deposit**.
   ...
   :::caution
   The minimum deposit amount is 50. Though you can enter an amount larger than 1,000, total deposits exceeding 10,000 in 24 hours will be subject to manual review and approval. Thus, to avoid delays, it's advised that each deposit be limited to 1,000 to allow multiple deposits in a 24-hour period automatically.
   :::
