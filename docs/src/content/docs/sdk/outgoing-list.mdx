...
The [List Outgoing Payments API](/apis/#resource-server/tag/outgoing-payment/GET/outgoing-payments) lets you list all outgoing payments on a wallet address.
...
- [Resource server API reference](/apis/#resource-server/tag/outgoing-payment/GET/outgoing-payments)
