...
The [List Incoming Payments API](/apis/resource-server/#tag/incoming-payment/GET/incoming-payments) lets you list all incoming payments on a wallet address.
...
- [Resource server API reference](/apis/resource-server/#tag/incoming-payment/GET/incoming-payments)
