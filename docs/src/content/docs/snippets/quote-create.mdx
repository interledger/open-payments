...
These code snippets create a quote with a fixed receive amount of $5 USD, meaning the payee (recipient) should receive $5 USD after any applicable fees. The debit amount, which is the amount to be deducted from the payer’s account, is also $5 USD, indicating there are no fees associated with this quote.
