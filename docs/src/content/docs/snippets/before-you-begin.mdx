...
5. Click **Deposit**.
   <img
     ...
     style='max-width:400px'
   />
6. Enter an amount between 50 to 1000 to deposit into the account, then click **Deposit**.

   :::caution
   The minimum deposit amount is 50. Though you can enter an amount larger than 1000, total deposits exceeding 10000 within 24 hours will be subject to manual review and approval. Thus, to avoid delays, it is advised that each deposit be limited to 1000 to allow multiple deposits within a 24-hour period automatically.
   :::
