...
7. Complete the KYC steps, and liveness check. The only real information you need to share is your email address and phone number. All other information can be fictitious. If a photo is required, it can be anything, as long as it's not blank.
...
1. Sign in to <LinkOut href='https://wallet.interledger-test.dev/'>wallet.interledger-test.dev</LinkOut>.
