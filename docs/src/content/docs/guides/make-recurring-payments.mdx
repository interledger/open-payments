...
- `assetScale` : the number of decimal places used to represent the minimum value in the corresponding asset code. EUR has an asset scale of 2 with a minimum possible value of €0.01.
