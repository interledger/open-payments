...
Using the merchant and platform access tokens provided in the quote responses, request the creation of two `outgoingPayment` resources on the customer's wallet account: one for the merchant and one for your platform.
