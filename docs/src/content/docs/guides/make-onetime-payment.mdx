...
- `assetScale` : the number of decimal places used to represent the minimum value in the corresponding asset code. USD has an asset scale of 2 with a minimum value of $0.01. An integer amount of 1000 with an `assetCode` of USD and `assetScale` of 2 translates to $10.00
