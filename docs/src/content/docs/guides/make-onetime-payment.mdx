...
### 1. Request an Incoming Payment grant
...
The optional `debitAmount` and `receiveAmount` parameters, which apply to the sender and recipient respectively, allow you to define the limits under which an outgoing payment can be created.
...
Next, indicate your client is capable of directing the end-user to a URI to start an interaction.
...
### 6. Start interaction with the end user
...
### 7. Finish interaction with the end user
...
### 8. Request a grant continuation
