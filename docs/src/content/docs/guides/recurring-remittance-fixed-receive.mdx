...
- **Recipient receives**: $4,000 each month for three months
...
- <Badge text="GET" variant="note" /> [Get an Outgoing Payment API](/apis/resource-server/operations/get-outgoing-payment/)
- <Badge text="POST" variant="success" /> [Complete Incoming Payment API](/apis/resource-server/operations/complete-incoming-payment/)
    ...
    "access": [
      {
        ...
        "limits": {
          "interval": "R3/2025-10-0323:25:00Z/P1M",
          "receiveAmount": {
            "assetCode": "MXN",
            "assetScale": 2,
            "value": "400000"
...
The first payment is now set up. You can optionally [complete the incoming payment](#9-complete-an-incoming-payment-optional).
...
### 9. Complete an incoming payment (optional)
...
```json wrap
{
  ...
  "createdAt": "2025-10-03T23:28:13.14Z",
}
```
</details>
...
```json wrap
{
  ...
  "walletAddress": "https://happylifebank.example.com/recipient",
  "incomingAmount": { // the maximum amount that should be paid into this incoming payment
    "value": "400000",
    "assetCode": "MXN",
    "assetScale": 2
  },
  ...
  "completed": true,
  "createdAt": "2025-10-03T23:28:15.00Z",
}
```
</details>
