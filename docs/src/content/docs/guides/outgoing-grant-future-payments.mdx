...
{
  "spentReceiveAmount": {
    // the total amount successfully received (by all receivers) for the current interval
    "value": "4500",
    "assetCode": "CAD",
    "assetScale": 2
  },
  "spentDebitAmount": {
    // the total amount successfully deducted from the sender's account for the current interval
    "value": "5000",
    "assetCode": "CAD",
    "assetScale": 2
  }
