...
3. Resolve the client's public key (refer to [Client key resolution](#client-key-resolution) below).
4. Verify the `Signature` header against the reconstructed signature base using that public key and Ed25519.
