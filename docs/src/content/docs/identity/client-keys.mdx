...
This page describes Open Payments from the client developer's perspective. ASEs should refer to the [ASE implementation guide](/implement/).
:::
...
:::note[For ASE implementors]
ASEs should refer to the [ASE implementation guide](/implement/).
:::
