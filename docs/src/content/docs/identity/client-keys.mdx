...
:::note[For ASEs]
This page describes how clients generate, register, and use their keys. If you're implementing Open Payments at your institution, refer to [Security](/implement/security/) for how your authorization server resolves and verifies these keys during grant requests.
:::
