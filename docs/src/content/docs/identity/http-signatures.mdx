...
:::note[For ASEs]
This page describes how clients sign their outgoing requests. If you're implementing Open Payments at your institution, refer to [Security](/implement/security/) for the server-side signature validation procedure your authorization and resource servers must perform on every incoming request.
:::
