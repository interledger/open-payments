...
:::note[For ASEs]
This page describes how clients request grants. If you're implementing Open Payments at your institution, refer to [Authorization server](/implement/auth-server/) for the server-side GNAP processing, including how to validate signatures, manage interactive sessions, and issue continuation URIs.
:::
