...
## Montos por debitar y recibir

Antes de conocer los componentes de los montos, debe comprender la diferencia entre los montos por debitar y los montos por recibir.

- Monto por debitar - El monto total que se cobrará a un remitente, en su activo o moneda, al completarse un pago saliente.
- Monto por recibir - El monto que se acreditará en la cuenta del destinatario en su activo o moneda.

## Valores

El primer componente que conforma un monto es un valor numérico (`value`).
...
El segundo componente de un monto es un `assetCode`.
...
El tercer componente de un monto es un `assetScale`.
