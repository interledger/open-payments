...
Luego de una interacción correcta, el cliente debe emitir una [Continuation Request](/es/apis/#tag/grant/POST/continue/%7Bid%7D), para que el servidor de autorización sepa que debe emitir un token de acceso.
