...
- <Badge text="GET" variant="note" /> <LinkOut href='https://openpayments.dev/apis/wallet-address-server/operations/get-wallet-address/'>Cómo obtener una dirección de billetera</LinkOut>
- <Badge text="POST" variant="success" /> <LinkOut href='https://openpayments.dev/apis/auth-server/operations/post-request/'>Solicitud de concesiones de autorización</LinkOut>
- <Badge text="POST" variant="success" /> <LinkOut href='https://openpayments.dev/apis/resource-server/operations/create-incoming-payment/'>Cómo crear un pago entrante</LinkOut>
- <Badge text="POST" variant="success" /> <LinkOut href='https://openpayments.dev/apis/resource-server/operations/create-quote/'>Cómo crear una cotización</LinkOut>
- <Badge text="POST" variant="success" /> <LinkOut href='https://openpayments.dev/apis/auth-server/operations/post-continue/'>Continuación de solicitud de concesión de autorización</LinkOut>
- <Badge text="POST" variant="success" /> <LinkOut href='https://openpayments.dev/apis/resource-server/operations/create-outgoing-payment/'>Cómo crear un pago saliente</LinkOut>
...
Llame a la <Badge text="GET" variant="note" /> [API Obtener dirección de billetera](/apis/wallet-address-server/operations/get-wallet-address) para cada dirección.
...
Utilice los datos del destinatario `authServer`, recibidos en el paso anterior, para llamar a la <Badge text="POST" variant="success" /> [API Solicitud de concesión](/apis/auth-server/operations/post-request/).
...
Use el token de acceso devuelto en la respuesta anterior para llamar a la <Badge text="POST" variant="success" /> [API Crear pago entrante](/apis/resource-server/operations/create-incoming-payment).
...
Utilice los datos del remitente `authServer` recibidos en el paso 1 para llamar a la <Badge text="POST" variant="success" /> [API Solicitud de concesión](/apis/auth-server/operations/post-request/).
...
Utilice el token de acceso recibido en el paso anterior para llamar a la <Badge text="POST" variant="success" /> [API Crear cotización](/apis/resource-server/operations/create-quote/).
...
Utilice la información del remitente `authServer` recibida en el paso 1 para llamar a la <Badge text="POST" variant="success" /> [API Solicitud de concesión](/apis/auth-server/operations/post-request).
...
Llame a la <Badge text="POST" variant="success" /> [API Continuación de solicitud de concesión](/apis/auth-server/operations/post-continue/). Esta llamada solicita un token de acceso que permite a su aplicación solicitar la creación de un recurso de pago saliente en la cuenta de billetera del remitente.
...
Utilice el token de acceso devuelto en el paso 9 para llamar a la <Badge text="POST" variant="success" /> [API Crear pago saliente](/apis/resource-server/operations/create-outgoing-payment/). Incluya el `quoteId` en la solicitud. La `quoteId` es la `id` devuelta en la respuesta de API Crear cotización (paso 5).
...
Si la solicitud falla porque la cotización expiró, [solicite una nueva](#5-solicitar-la-creación-de-un-recurso-de-cotización) e intente otra vez. Si falla porque el token de acceso de la concesión de autorización ha expirado, llame a <Badge text="POST" variant="success" /> [Rotar el token de acceso](/apis/auth-server/operations/post-token/) para obtener un nuevo token de acceso y, luego, vuelva a probar la solicitud con el nuevo token.
