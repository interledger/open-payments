...
Supongamos que su usuario guardó su dirección de billetera en el perfil de su cuenta al configurar la aplicación. Llame a la [Get Wallet Address API](/apis/#tag/wallet-address/GET/) para obtener los datos necesarios sobre la cuenta de la billetera del usuario.
