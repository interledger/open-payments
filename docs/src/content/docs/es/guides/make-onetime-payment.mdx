...
- `method`: el método de pago que se utiliza para facilitar el pago. Configurar esta propiedad para `ilp`, ya que Open Payments solo admite pagos de <LinkOut href='https://interledger.org'>Interledger</LinkOut> en la actualidad.
