...
- <Badge text="GET" variant="note" />
  <LinkOut href="/apis/#tag/wallet-address/GET/">Get Wallet Address</LinkOut>
- <Badge text="POST" variant="success" />
  <LinkOut href="/apis/#tag/grant/POST/">Grant Request</LinkOut>
- <Badge text="POST" variant="success" />
  <LinkOut href="/apis/#tag/incoming-payment/POST/incoming-payments">
    Create an Incoming Payment
  </LinkOut>
- <Badge text="POST" variant="success" />
  <LinkOut href="/apis/#tag/quote/POST/quotes">Create a Quote</LinkOut>
- <Badge text="POST" variant="success" />
  <LinkOut href="/apis/#tag/outgoing-payment/POST/outgoing-payments">
...
Llame a la <Badge text="GET" variant="note" /> [Get Wallet Address](/apis/#tag/wallet-address/GET/) para cada dirección.
...
Utilice los datos del comerciante y de la plataforma `authServer`, recibidos en el paso anterior, para llamar a la <Badge text="POST" variant="success" /> [Grant Request API](/apis/#tag/grant/POST/).
...
Use los tókenes de acceso devueltos en las respuestas anteriores para llamar a la <Badge text="POST" variant="success" /> [Create an Incoming Payment API](/apis/#tag/incoming-payment/POST/incoming-payments).
...
Utilice los datos del consumidor `authServer`, recibidos en el paso 1, para llamar a la <Badge text="POST" variant="success" /> [Grant Request API](/apis/#tag/grant/POST/).
...
Utilice el token de acceso recibido en el paso anterior para llamar a la <Badge text="POST" variant="success" />[Create Quote API](/apis/#tag/quote/POST/quotes).
...
Utilice la información del consumidor `authServer` recibida en el paso 1 para llamar a la <Badge text="POST" variant="success" /> [Grant Request API](/apis/#tag/grant/POST/).
...
Llame a la <Badge text="POST" variant="success" /> [Grant Continuation Request API](/apis/#tag/grant/POST/continue/%7Bid%7D). El propósito de esta llamada consiste en solicitar un token de acceso que permita a su plataforma solicitar la creación de recursos de pago saliente en la cuenta de la billetera del consumidor.
...
Utilice los tókenes de acceso devueltos en el paso 5 para llamar a la <Badge text="POST" variant="success" /> [Create an Outgoing Payment API](/apis/#tag/outgoing-payment/POST/outgoing-payments).
