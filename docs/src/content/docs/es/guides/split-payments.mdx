...
Llame a la [API Obtener dirección de billetera](/apis/wallet-address-server/operations/get-wallet-address) para cada dirección.
...
Utilice los datos del comerciante y de la plataforma `authServer`, recibidos en el paso anterior, para llamar a la [API Solicitud de concesión](/apis/auth-server/operations/post-request).
...
Use los tókenes de acceso devueltos en las respuestas anteriores para llamar a la [API Crear pago entrante](/apis/resource-server/operations/create-incoming-payment).
...
Utilice los datos del consumidor `authServer`, recibidos en el paso 1, para llamar a la [API Solicitud de concesión](/apis/auth-server/operations/post-request).
...
Utilice el token de acceso recibido en el paso anterior para llamar a la [API Crear cotización](/apis/resource-server/operations/create-quote).
