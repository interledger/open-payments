...
- <Badge text="GET" variant="note" />
  <LinkOut href="/apis/#wallet-address-server/tag/wallet-address/GET/">
    Get Wallet Address
  </LinkOut>
- <Badge text="POST" variant="success" />
  <LinkOut href="/apis/#auth-server/tag/grant/POST/">Grant Request</LinkOut>
- <Badge text="POST" variant="success" />
  <LinkOut href="/apis/#resource-server/tag/incoming-payment/POST/incoming-payments">
    Create an Incoming Payment
  </LinkOut>
- <Badge text="POST" variant="success" />
  <LinkOut href="/apis/#resource-server/tag/quote/POST/quotes">
    Create a Quote
  </LinkOut>
- <Badge text="POST" variant="success" />
  <LinkOut href="/apis/#resource-server/tag/outgoing-payment/POST/outgoing-payments">
