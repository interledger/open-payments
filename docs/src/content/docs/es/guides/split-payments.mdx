...
Llame a la <Badge text="GET" variant="note" /> [Get Wallet Address](/apis/wallet-address-server/#tag/wallet-address/GET/) para cada dirección.
...
El siguiente ejemplo muestra respuestas de los proveedores de billetera del consumidor, del comerciante y de la plataforma.
...
Utilice los datos del comerciante y de la plataforma `authServer`, recibidos en el paso anterior, para llamar a la <Badge text="POST" variant="success" /> [Grant Request API](/apis/auth-server/#tag/grant/POST/).
...
El siguiente ejemplo muestra una respuesta del proveedor de billetera del comerciante. Se devolverá una respuesta similar desde su proveedor de billetera.
...
Use los tókenes de acceso devueltos en las respuestas anteriores para llamar a la <Badge text="POST" variant="success" /> [Create an Incoming Payment API](/apis/resource-server/#tag/incoming-payment/POST/incoming-payments).
...
El siguiente ejemplo muestra una respuesta del proveedor de billetera del comerciante. Se devolverá una respuesta similar desde su proveedor de billetera, pero el `value` de su `incomingAmount` será `100`.
...
El siguiente ejemplo muestra una respuesta del proveedor de billetera del consumidor.
...
Utilice la información del consumidor `authServer` recibida en el paso 1 para llamar a la <Badge text="POST" variant="success" /> [Grant Request API](/apis/auth-server/#tag/grant/POST/).
...
Llame a la <Badge text="POST" variant="success" /> [Grant Continuation Request API](/apis/auth-server/#tag/grant/POST/continue/%7Bid%7D). El propósito de esta llamada consiste en solicitar un token de acceso que permita a su plataforma solicitar la creación de recursos de pago saliente en la cuenta de la billetera del consumidor.
...
Utilice los tókenes de acceso devueltos en el paso 5 para llamar a la <Badge text="POST" variant="success" /> [Create an Outgoing Payment API](/apis/resource-server/#tag/outgoing-payment/POST/outgoing-payments).
...
El siguiente ejemplo muestra una respuesta cuando se crea un recurso de pago saliente en la cuenta del cliente para el comerciante. Se devolverá una respuesta similar cuando se cree un recurso de pago saliente para usted, como proveedor de billetera.
