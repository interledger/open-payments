...
Los puntos finales orientados al cliente correspondientes son <LinkOut href='/apis/auth-server/operations/post-token'>Rotate access token</LinkOut> y <LinkOut href='/apis/auth-server/operations/delete-token'>Revoke access token</LinkOut>.
