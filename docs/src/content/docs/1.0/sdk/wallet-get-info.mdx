...
<Tabs>
  <TabItem label="TypeScript/JavaScript" icon="seti:javascript">
    ...
    <ChunkedSnippet source="https://raw.githubusercontent.com/interledger/open-payments-snippets/main/wallet-address/wallet-address-get.ts" chunk="3" />

    <ChunkedSnippet source="https://raw.githubusercontent.com/interledger/open-payments-snippets/main/wallet-address/wallet-address-get.ts" chunk="4" />
  ...
  <TabItem label="PHP" icon="seti:php">
    ...
    <ChunkedSnippet source="https://raw.githubusercontent.com/interledger/open-payments-php-snippets/refs/heads/main/src/Command/WalletAddress/PublicGetWalletAddress.php" chunk="3" />

    <ChunkedSnippet source="https://raw.githubusercontent.com/interledger/open-payments-php-snippets/refs/heads/main/src/Command/WalletAddress/PublicGetWalletAddress.php" chunk="4" />
...
* [API specification](/1.0/apis/wallet-address-server/operations/get-wallet-address)
* [Wallet addresses](/1.0/concepts/wallet-addresses)
