...
- The <Tooltip content="A mobile or web application or service" client:load>client's</Tooltip> user is the sender.
- The client already has the sender's Open Payments-enabled account details and is able to send payments on behalf of the sender.
