...
The payment method is the means by which the sender's ASE will fulfill its payment obligations to the recipient's ASE. Cash, credit and debit cards, bank transfers, gift cards and mobile money can all be considered different payment methods.
