...
import {
  ...
  LinkOut,
  Tooltip,
  Mermaid,Document the eCommerce use-case from the point of view of an online marketplace where merchants sell products to shoppers.

Content based on https://github.com/interledger/open-payments/blob/main/packages/open-payments/README.md
MermaidWrapper
...
</LinkOut> implementation that includes support for integration with an <LinkOut href='https://github.com/interledger/rafiki/blob/8fb69da214ae253eb380e78a61b80ae394a62fe7/packages/auth/src/openapi/id-provider.yaml'>
  IdP
</LinkOut>
.
