...
An `assetCode` is a code representation of the underlying asset used to make a payment. The `assetCode` should be an <LinkOut href='https://en.wikipedia.org/wiki/ISO_4217'>ISO 4217</LinkOut> currency code. The ISO 4217 currency code representing the US Dollar is USD.
