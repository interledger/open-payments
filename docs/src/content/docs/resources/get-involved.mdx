...
- OpenAPI package <LinkOut href='https://github.com/interledger/open-payments-node/tree/main/packages/openapi'>API definitions and schemas</LinkOut>
- HTTP Signature Util <LinkOut href='https://github.com/interledger/open-payments-node/tree/main/packages/http-signature-utils'>Security utilities</LinkOut>
...
- Join our <LinkOut href='https://calendar.google.com/calendar/u/1/r/eventedit/MG1tYzlwOHVtMmg5dnQxOXNodWc4czdxdG5fMjAyNjA1MDdUMTIwMDAwWiBiaWJpYW5hQGludGVybGVkZ2VyLm9yZw'>Open Payments Community calls</LinkOut> for regular discussions
...
- Ask questions in the `#open-payments` <LinkOut href='https://communityinviter.com/apps/interledger/interledger-working-groups-slack'>Slack channel</LinkOut> for quick assistance
- Start a <LinkOut href='https://github.com/interledger/open-payments/discussions'>discussion</LinkOut> on GitHub for broader topics and technical deep-dives
